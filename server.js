...
import { recursive } from "./algorithms/recursive.js";
import { iterative } from "./algorithms/iterative.js";
...
//     runtime: {
//     iterativeMs: Number((iterEnd - iterStart).toFixed(2)),
//     recursiveMs: Number((recEnd - recStart).toFixed(2))
//     },
//     preselectPlayers: {
